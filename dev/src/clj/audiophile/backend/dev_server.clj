...
(def reload!
  (let [reload* (rel/wrap-reload identity {:dirs ["src/clj"
    ...
    (fn []
      ...
      (require 'audiophile.backend.infrastructure.repositories.common :reload)
      (require 'audiophile.backend.infrastructure.repositories.core :reload)
      (require 'audiophile.backend.infrastructure.repositories.comments.impl :reload)
      (require 'audiophile.backend.infrastructure.repositories.events.impl :reload)
      (require 'audiophile.backend.infrastructure.repositories.files.impl :reload)
      (require 'audiophile.backend.infrastructure.repositories.projects.impl :reload)
      (require 'audiophile.backend.infrastructure.repositories.teams.impl :reload)
      (require 'audiophile.backend.infrastructure.repositories.users.impl :reload)
