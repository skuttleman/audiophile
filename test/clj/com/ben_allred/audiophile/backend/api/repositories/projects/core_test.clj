(ns ^:unit com.ben-allred.audiophile.backend.api.repositories.projects.core-test
  (:require
...
(defn ^:private ->project-executor
  ...
  ([executor {:keys [emitter event-types events projects pubsub user-teams users]}]
