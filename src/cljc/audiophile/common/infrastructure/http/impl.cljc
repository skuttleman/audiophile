...
(defn ^:private http-base#request! [http-client timeout request]
...
(deftype HttpBase [http-client timeout]
  pres/IResource
  (request! [_ request]
    (http-base#request! http-client timeout request)))

(defn ^:private http-logger#request! [this http-client request]
...
(deftype HttpLogger [http-client]
  ...
  (request! [this request]
    (http-logger#request! this http-client request)))

(defn ^:private http-headers#request! [http-client request]
...
(deftype HttpHeaders [http-client]
  pres/IResource
  (request! [_ request]
    (http-headers#request! http-client request)))

(defn ^:private http-serde#request! [http-client serdes request]
...
(deftype HttpSerde [http-client serdes]
  pres/IResource
  (request! [_ request]
    (http-serde#request! http-client serdes request)))

(defn ^:private http-progress#request! [http-client request]
...
(deftype HttpProgress [http-client]
  pres/IResource
  (request! [_ request]
    (http-progress#request! http-client request)))
