(ns audiophile.backend.infrastructure.system.handlers
  (:require
    ...
    [audiophile.backend.api.handlers.team-invitations :as invitations]
...
(defmethod ig/init-key :audiophile.handlers.files/update [_ cfg]
  (files/modify cfg))
...
(defmethod ig/init-key :audiophile.handlers.projects/update [_ cfg]
  (projects/patch cfg))
...
(defmethod ig/init-key :audiophile.handlers.teams-invitations/create [_ cfg]
  (invitations/create cfg))

(defmethod ig/init-key :audiophile.handlers.teams-invitations/update [_ cfg]
  (invitations/modify cfg))

(defmethod ig/init-key :audiophile.handlers.teams-invitations/fetch-all [_ cfg]
  (invitations/fetch-all cfg))
